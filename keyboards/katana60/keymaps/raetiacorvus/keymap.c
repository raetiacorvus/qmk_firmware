...
[SYM] = LAYOUT(
  ...
  _______, DE_AT,   DE_RING, DE_EURO, DE_SS,   _______, _______,          _______, _______, DE_UE,   DE_QST,  DE_OE,   DE_ASTR, KC_DEL,
  _______, DE_AE,   DE_LCBR, DE_LBRC, DE_LPRN, DE_SLSH, KC_VOLD,          KC_VOLU, DE_TILD, DE_RPRN, DE_RBRC, DE_RCBR, DE_DQOT, _______,
  _______, DE_LESS, DE_MORE, DE_PIPE, _______, DE_BSLS, KC_MPRV, KC_MPLY, KC_MNXT, _______, DE_CIRC, DE_ACUT, DE_GRV, DE_PLUS,  _______,
...
[NUM] = LAYOUT(
  ...
  _______, DE_EXLM, DE_DQOT, DE_PARA, DE_DLR,  DE_PERC, _______, _______, _______, DE_AMPR, DE_SLSH, DE_LPRN, DE_RPRN, DE_EQL,  _______,
  _______, _______, _______, _______,                   _______, _______, _______,          _______, _______, _______, _______, _______
    ),
[NUP] = LAYOUT(
